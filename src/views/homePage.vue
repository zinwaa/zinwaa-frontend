            ...
            <div class="zinwaaInfo">
                <card>
                    ...
                    <div class="contact">
                        ...
                        <div class="contact-item">
                            <div class="item">
                                <svg data-v-23ac1662="" viewBox="0 0 48 48" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="arco-icon arco-icon-qq" stroke-width="4"
                        ...
                        <div class="contact-item">
                            <div class="item">
                                <svg data-v-23ac1662="" viewBox="0 0 48 48" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="arco-icon arco-icon-wechat"
